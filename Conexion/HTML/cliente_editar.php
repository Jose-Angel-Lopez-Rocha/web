<<<<<<< HEAD:Conexion/HTML/cliente_editar.php
<?php
$server = "localhost";
$user   = "root";
$pass   = "";
...
<body>
    ...
    <table>
        ...
        <tr>
            ...
            <td><a href="cliente_editar_2.php?id=<?= $mostrar['IDCliente'] ?>" class="boton3">Editar</a></td>
        </tr>
        <?php
            }
        }else{
...
>>>>>>> 7b8f87f (Descripción breve de los cambios):HTML/cliente_editar.php
</html>